...
import static WUSL.controller.manageInventoryController.inventory;
...
public class placeOrderController {
    ...
    public void placeHolder(ActionEvent actionEvent) throws JRException, ClassNotFoundException, SQLException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/inventoryInfo", "root", "faraFARA");
    ...
    public void generatePlaceOrderReport() throws JRException, SQLException, ClassNotFoundException {
        ...
        JasperPrint filledReport = JasperFillManager.fillReport(compileReport,params,DriverManager.getConnection("jdbc:mysql://localhost:3306/inventoryInfo", "root", "faraFARA"));
